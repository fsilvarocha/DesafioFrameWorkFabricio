...
namespace frwkFabricioSIlva.Controllers
{
    public class TipoUsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao")] TipoUsuario tipoUsuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao")] TipoUsuario tipoUsuario)
        {
