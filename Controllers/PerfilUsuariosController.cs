...
namespace frwkFabricioSIlva.Controllers
{
    public class PerfilUsuariosController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["TipoUsuarioId"] = new SelectList(_context.TipoUsuario, "Id", "Descricao");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,TipoUsuarioId,UserId")] PerfilUsuario perfilUsuario)
        {
            ...
            ViewData["TipoUsuarioId"] = new SelectList(_context.TipoUsuario, "Id", "Id", perfilUsuario.TipoUsuarioId);
            return View(perfilUsuario);
        }
