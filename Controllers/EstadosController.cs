...
namespace frwkFabricioSIlva.Controllers
{
    public class EstadosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PaisId,Descricao")] Estado estado)
        {
            ...
            ViewData["PaisId"] = new SelectList(_context.Pais, "Id", "Descricao", estado.PaisId);
            return View(estado);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PaisId,Descricao")] Estado estado)
        {
            if (id != estado.Id)
            {
                return NotFound();
